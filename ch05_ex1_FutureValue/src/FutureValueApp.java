...
public class FutureValueApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			PrintFormattedResults(monthlyInvestment, interestRate, months, futureValue);
			 choice = askToContinue("Continue? (y/n): ", sc, choice);
		}
	...
	// adding PrintFormattedResults static method
	...
	public static String askToContinue (String prompt, Scanner sc, String choice) {
