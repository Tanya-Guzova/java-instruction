...
public class MonthSelectorApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			//calculating the sum of entered monthsSales - my calcApp enhancement
			askedSales = askedSales + monthS;
			System.out.println("Sales for " + monthName + ": " + monthS);
		...
		//regular for loop to display the total sales for the year
		/*double sum = 0;
		...
		*/
		System.out.println("Total sales: " + currency.format(askedSales));
		Console.displayLine();
	}
